...
public class Main {
    /**
     * Необходимо реализовать класс-обертку над массивом freeIt.hw16.task1.ArrayWrapper,
     ...
     * Реализовать класс-исключение throw new freeIt.hw16.task1.IncorrectArrayWrapperIndex
